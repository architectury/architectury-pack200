...
class ClassWriter {
    ...
    void write() throws IOException {
        ...
        try {
            ...
            writeAttributes(Constants.ATTR_CONTEXT_CLASS, cls);
    ...
    void writeConstantPool() throws IOException {
        ConstantPool.Entry[] cpMap = cls.cpMap;
        ...
        for (int i = 0; i < cpMap.length; i++) {
            ...
            switch (tag) {
                ...
                case Constants.CONSTANT_Integer:
                    out.writeInt(((ConstantPool.NumberEntry)e).numberValue().intValue());
                    break;
                ...
                case Constants.CONSTANT_Long:
                    out.writeLong(((ConstantPool.NumberEntry)e).numberValue().longValue());
                    break;
    ...
    void writeMembers(boolean doMethods) throws IOException {
        List<? extends Package.Class.Member> mems;
        if (!doMethods)
            mems = cls.getFields();
        else
            mems = cls.getMethods();
    ...
    void writeMember(Package.Class.Member m, boolean doMethod) throws IOException {
        ...
        writeAttributes(!doMethod ? Constants.ATTR_CONTEXT_FIELD : Constants.ATTR_CONTEXT_METHOD,
                        m);
    }
    ...
    void writeCode(Code code) throws IOException {
        ...
        writeAttributes(Constants.ATTR_CONTEXT_CODE, code);
    }
